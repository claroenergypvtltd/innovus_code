...
export const resorceJSON = {
  ...
  RetailerList: [
    { name: 'Status', selector: 'selectBox' },
    { name: 'Onboarded Date', selector: 'created' },
    { name: 'Customer ID', selector: 'cusId' },
    { name: 'Shop Name', selector: 'shopNames' },
    { name: 'Shop Address', selector: 'shopAddrss1' },
    { name: 'Shop Locality', selector: 'shopLocalty' },
    { name: 'Phone Number', selector: 'mobileNumber' },
    { name: 'Shop Type', selector: 'shopType' },
    { name: 'Agent Name', selector: 'agentName' },
  ...
  VehicleList: [
    ...
    { name: 'Estimated Transaction Time', selector: 'transitionTime', sortable: true },
    { name: 'Time Window at Operation', selector: 'operatingHour', sortable: true },
  ],
