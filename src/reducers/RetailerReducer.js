import { RET_USER_FETCH_SUCCESS, RET_KYC_FETCH_SUCCESS, RETAILER_FETCH_SUCCESS, RETAILER_CREATE_SUCCESS, RETAILER_UPDATE_SUCCESS, RETAILER_DELETE_SUCCESS } from '../constants/actionTypes'
...
export default function (state = initialstate, action) {
    ...
    switch (action.type) {
        ...
        case RET_USER_FETCH_SUCCESS:
            return state = {
                ...state,
                Userlist: action.Lists,
                // count: action.count
            }
